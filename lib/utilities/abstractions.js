 ...
 */
AbstractPart = (function (url, width, height, depth, itemId, partType, footprint, renderShape) {
	var _id = null;
	/**
	...
	return {
		...
		itemId: itemId,
		partType: partType,
		footprint: footprint || LayoutFootprintType.ellipse,
		renderShape: renderShape || RenderShapeType.sphere,
		setId: _setId
	};
});
