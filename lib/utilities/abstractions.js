 ...
 * @type {{Init: number, NewPart: number, SetThreeContext: number, ComponentMounted: number, ComponentWillUnmount: number}}
 */
RenderActionType = {
	NewPart: 3001,
	SetThreeContext: 3002
};
/**
 * Layout specific actions
 * @type {{Init: number, EnumerateParts: number, SetAbstractPart: number, NotifySelectedPart: number, SetPixiContext: number, ResizeLayout: number}}
 */
LayoutActionType = {
	EnumerateParts: 2001,
	SetAbstractPart: 2002,
	NotifySelectedPart: 2003,
	SetPixiContext: 2004,
	ResizeLayout: 2005
};
/**
 * Common view actions
 * @type {{Init: number, ResizeLayout: number}}
 */
ViewActionType = {
	Init: 1000,
	ResizeLayout: 1001,
	ComponentMounted: 1003,
	ComponentWillUnmount: 1004
};
/**
